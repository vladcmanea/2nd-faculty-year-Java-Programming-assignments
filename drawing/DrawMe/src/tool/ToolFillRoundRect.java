...
/**
 * ToolFillRoundRect class
 * @author vladm
 */
public class ToolFillRoundRect extends Tool {
     ...
     */
    public ToolFillRoundRect(CanvasPanel panel) {
    ...
    public void design(BufferedImage image, boolean clean) {
        ...
        if (clean == false) {
            ...
            if (created == false) {
                ...
                // draw rect
                graph.fillRect(minx, miny, maxx - minx, maxy - miny);

            } else {

                // draw oval
                graph.fillRoundRect(minx, miny, maxx - minx, maxy - miny, distanceX, distanceY);
