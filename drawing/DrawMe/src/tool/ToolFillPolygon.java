...
/**
 * ToolFillPolygon class
 * @author vladm
 */
public class ToolFillPolygon extends Tool {
     ...
     */
    public ToolFillPolygon(CanvasPanel panel) {
    ...
    public void design(BufferedImage image, boolean clean) {
        ...
        if (clean == false) {
            ...
            if (pointN > 0) {
                ...
                // draw poly
                graph.fillPolygon(pointX, pointY, pointN);
            ...
            if (pointN > 0) {
                ...
                if (pointN < 1024) {
                    ...
                    // add X coordinate
                    pointX[pointN] = new Integer(current.x);

                    // add y coordinate
                    pointY[pointN] = new Integer(current.y);
